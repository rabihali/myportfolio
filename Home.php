...
<img src="images/logo.png">
      ...
      <ul class="nav__links">
        <li class="link"><a href="#header__container">Home</a></li>
        <li class="link"><a href="#explore__container">Program</a></li>
        <li class="link"><a href="#class__container">Class</a></li>
        <li class="link"><a href="#join__container">About</a></li>
        <li class="link"><a href="#price__container">Community</a></li>
      </ul>
     <a href="Login.php"> <button class="btn">Join Now</button></a>
    </nav>

    <header class="section__container header__container" class="header__container">
      ...
      <div class="header__image">
        <img src="images/header.avif" alt="header" />
      </div>
    </header>

    <section class="section__container explore__container" id="explore__container">
    ...
    <section class="section__container class__container" id="class__container">
    ...
    <section class="section__container join__container" id="join__container">
    ...
    <section class="section__container price__container" id="price__container">
